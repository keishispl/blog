<script lang="ts">
  ...
  import { decryptContent } from "@/toolkit/encryption/crypto.ts";
  import { encryptedTocStore } from "@/stores/encryptedTocStore.ts";
  import { currentLocale, getT } from "@/i18n/index.ts";
